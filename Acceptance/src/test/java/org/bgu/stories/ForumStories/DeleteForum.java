...
public class DeleteForum extends ForumCreatedTestBase {
    ...
    *
    ...
    public void DeleteForum_byManager_fail_testID_10_2(){
        assertTrue("could not log out admin", bridge.login(MANAGER_NAME,MANAGER_PASS));
        assertFalse("manager can delete forum", bridge.deleteForum(FORUM_NAME));
    }
    @Test
    public void DeleteForum_byMemebr_fail_testID_10_3(){
        assertTrue("could not log out admin", bridge.login(MEMBER_NAME,MEMBER_PASS));
    ...
    public void DeleteForum_byAdmin_DeleteTwice_pass_testID_10_5(){
        assertTrue("can not log out admin", bridge.login(ADMIN1_NAME,ADMIN1_PASS));
